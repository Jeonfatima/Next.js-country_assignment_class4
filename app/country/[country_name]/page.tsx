...
const CountryName = ({ params }: { params: { country_name: string } }) => {
  if (params.country_name == "pakistan") {
    return (
      <div className="font-bold text-yellow-400 ml-7">
    ...
    return (
      <div className="font-bold text-orange-400 ml-7">
        <h1 className="text-2xl text-white font-bold underline p-4">
    ...
    return (
      <div className="font-bold text-purple-400 ml-7">
        <h1 className="text-2xl text-white font-bold underline p-4">
    ...
    return (
      <div className="font-bold text-green-300 ml-7">
        <h1 className="text-2xl text-white font-bold underline p-4">
  ...
  } else if (params.country_name == "korea") {
    return (
      <div className="font-bold text-blue-300 ml-7">
        <h1 className="text-2xl text-white font-bold underline p-4">
          Country: {country_data.korea.name}
        </h1>
        <p>Name: {country_data.korea.name}</p>
        <p>Population: {country_data.korea.population}</p>
        <p>Capital: {country_data.korea.capital}</p>
